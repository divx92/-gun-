...
class public_game_tickets_view extends ipsCommand
{
	public function doExecute( ipsRegistry $registry )
	{
		...
		$this->registry->output->addContent( $this->registry->output->getTemplate( 'game' )->tickets_view( $ticket, $answers, $html ) );
